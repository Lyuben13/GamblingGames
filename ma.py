...
def main():
    ...
    while running:
        ...
        # Проверка за колизии със стена
        max_cells_x = window_x // cell_size
        max_cells_y = window_y // cell_size
        if (snake_position[0] < 0 or snake_position[0] >= max_cells_x or
            snake_position[1] < 0 or snake_position[1] >= max_cells_y):
            game_over_screen(score, game_window, window_x, window_y)

        # Проверка за удари в тялото
